...
fetch = function(query) {
	...
	d3.json("/fetch/"+query, function(error, payload) {
		...
		eqtls_plot = new ScatterPlot("#eqtls_plot_container", eqtl_data, {title:'Expression QTLs for ' + query,width:800,height: 280, extractX:qmapX, extractY:qmapY, extractColor:colorRed, extractRadius:sizeThem, xLabel:"chr:pos", yLabel:"-log10 [p-value]", onclick:onclickFunction})
		isoqtls_plot = new ScatterPlot("#isoqtls_plot_container", isoqtl_data, {title:'Isoform QTLs for ' + query,width:800,height: 280, extractX:qmapX, extractY:qmapY, extractColor:colorRed, extractRadius:sizeThem, xLabel:"chr:pos", yLabel:"-log10 [p-value]", onclick:onclickFunction})
